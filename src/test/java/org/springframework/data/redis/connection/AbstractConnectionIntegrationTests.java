...
public abstract class AbstractConnectionIntegrationTests {
	...
	public void testTtlWithTimeUnit() {
		...
		assertThat((Long) results.get(1)).isGreaterThan(TimeUnit.SECONDS.toMillis(5)).isLessThanOrEqualTo(TimeUnit.SECONDS.toMillis(10));
	}
	...
	public void testPTtlWithTimeUnit() {
		...
		assertThat((Long) results.get(1)).isGreaterThan(TimeUnit.MINUTES.toSeconds(9));
		assertThat((Long) results.get(1)).isLessThanOrEqualTo(TimeUnit.MINUTES.toSeconds(10));
	}
	...
	public void geoDist() {
		...
		List<Object> result = getResults();
		assertThat(((Distance) result.get(1)).getValue()).isCloseTo(166274.15156960033D, offset(0.005));
	...
	public void geoDistWithMetric() {
		...
		List<Object> result = getResults();
		assertThat(((Distance) result.get(1)).getValue()).isCloseTo(166.27415156960033D, offset(0.005));
	...
	public void geoHash() {
		...
		List<Object> result = getResults();
		assertThat((List<String>) result.get(1)).containsSequence("sqc8b49rny0", "sqdtr74hyu0");
	}
	...
	public void geoHashNonExisting() {
		...
		List<Object> result = getResults();
		assertThat((List<String>) result.get(1)).containsSequence("sqc8b49rny0", null, "sqdtr74hyu0");
	}
	...
	public void geoPosition() {
		...
		List<Object> result = getResults();
		assertThat(((List<Point>) result.get(1)).get(0).getX()).isCloseTo(POINT_PALERMO.getX(), offset(0.005));
		assertThat(((List<Point>) result.get(1)).get(0).getY()).isCloseTo(POINT_PALERMO.getY(), offset(0.005));

		assertThat(((List<Point>) result.get(1)).get(1).getX()).isCloseTo(POINT_CATANIA.getX(), offset(0.005));
		assertThat(((List<Point>) result.get(1)).get(1).getY()).isCloseTo(POINT_CATANIA.getY(), offset(0.005));
	}
	...
	public void geoPositionNonExisting() {
		...
		assertThat(((List<Point>) result.get(1)).get(2).getX()).isCloseTo(POINT_CATANIA.getX(), offset(0.005));
		assertThat(((List<Point>) result.get(1)).get(2).getY()).isCloseTo(POINT_CATANIA.getY(), offset(0.005));
	...
	public void geoRadiusShouldReturnDistanceCorrectly() {
		...
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent()).hasSize(3);
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent().get(0).getDistance().getValue()).isCloseTo(130.423D, offset(0.005));
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent().get(0).getDistance().getUnit()).isEqualTo("km");
	}
	...
	public void geoRadiusByMemberShouldReturnMembersCorrectly() {
		...
		List<Object> results = getResults();
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent().get(0).getContent().getName()).isEqualTo(PALERMO.getName());
	...
	public void geoRadiusByMemberShouldReturnDistanceCorrectly() {
		...
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent().get(0).getDistance().getValue())
				.isCloseTo(90.978D, offset(0.005));
		assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent().get(0).getDistance().getUnit()).isEqualTo("km");
	}
